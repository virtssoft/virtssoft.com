...
export const NAV_ITEMS: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: 'Informatiques (SaaS)', href: '#software' },
    ],
  },
  {
    label: 'Services',
  ...
  { label: 'Médias', href: '#media', type: NavigationType.LINK },
  { label: 'Blog', href: '#blog', type: NavigationType.LINK },
  { label: 'À propos', href: '#about', type: NavigationType.LINK },
...
export const Icons = {
  ...
  Menu: ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className} style={style}>
